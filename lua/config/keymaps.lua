...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		vim.keymap.set("n", "[d", vim.diagnostic.goto_prev, lsp_opts) -- jump to previous diagnostic in buffer

		lsp_opts.desc = "Go to next diagnostic"
		vim.keymap.set("n", "]d", vim.diagnostic.goto_next, lsp_opts) -- jump to next diagnostic in buffer
